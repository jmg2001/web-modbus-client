...
export default function Settings() {
  ...
  const changeRegister = (value: string, param: keyof ModbusRegisterParams) => {
    const updatedRegisters = { ...currentRegisters };

    // Convierte value al tipo correcto
    if (param === "start" || param === "length") {
      updatedRegisters[param] = Number(value) as any; // o usar parseInt
    } else if (param === "type") {
      updatedRegisters[param] = value as ModbusRegistersTypes;
    }

    setCurrentRegisters(updatedRegisters);
  };
